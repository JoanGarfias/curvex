...
const menuOptions = [
  {
    ...
    icon: BarChart3,
    route: '/calculadora', // <--- RUTA A TU VISTA ACTUAL
    color: "text-blue-500",
    bg: "bg-blue-500/10"
  },
  {
    ...
    icon: CheckCircle2,
    route: '/muestreo-aceptacion', // <--- RUTA A LA NUEVA VISTA
    color: "text-[#9a9563]", // Usando tu color dorado/café del tema
    bg: "bg-[#9a9563]/10"
  }
];
</script>
  ...
  <div class="min-h-screen flex flex-col items-center bg-gradient-to-br from-[#f8fafc] to-[#eef2f3] dark:from-[#0f0f0f] dark:to-[#1a1a1a] text-gray-800 dark:text-gray-100 transition-all p-4 sm:p-6">
    ...
    <header class="text-center mb-10 sm:mb-14 max-w-3xl px-4">
      <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4">
        Herramientas de <span class="text-[#9a9563]">Análisis</span>
      </h1>
    ...
    <main class="w-full max-w-5xl px-2 sm:px-4 flex-grow">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        <Link 
          ...
          :key="index" 
          :href="option.route"
          class="group relative flex flex-col p-6 sm:p-8 rounded-2xl bg-white/80 dark:bg-[#0b0b0b]/80 backdrop-blur border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-xl hover:border-[#9a9563]/50 transition-all duration-300 transform hover:-translate-y-1"
        >
          ...
          <h2 class="text-2xl font-bold mb-3 group-hover:text-[#9a9563] transition-colors">
            {{ option.title }}
          </h2>
          ...
          <div class="flex items-center text-sm font-semibold text-[#9a9563] mt-auto">
