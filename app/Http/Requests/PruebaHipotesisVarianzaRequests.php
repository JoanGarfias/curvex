...
class PruebaHipotesisVarianzaRequests extends ApiFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'desviacion' => 'required|numeric|min:0',
    ...
    public function messages(): array
    {
        return [
            ...
            'desviacion.required' => 'El campo desviacion es obligatorio.',
            'desviacion.numeric' => 'El campo desviacion debe ser un número.',
            'desviacion.min' => 'El campo desviacion debe ser al menos 0.',
