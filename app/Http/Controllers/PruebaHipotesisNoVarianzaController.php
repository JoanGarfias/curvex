<?php
/* Codigo no terminado, terminar de adaptarlo para la tabla 2.3 */
...
class PruebaHipotesisNoVarianzaController extends Controller
{
    ...
    public function calcular2(PruebaHipotesisVarianzaRequests2 $request){
        ...
        $z0 = ($promedio1 - $promedio2) / sqrt(($varianza1/$cantidad1) + ($varianza2/$cantidad2));
        $distribution = new StudentT($cantidad1 + $cantidad2 - 2);
