...
Route::get('/estadistica-descriptiva', function () {
    return Inertia::render('EstadisticaDescriptiva');
})->name('calculadora');

Route::get('/muestreo-aceptacion', function () {
    return Inertia::render('MuestreoAceptacion');
})->name('muestreo');

Route::get('/correccion-varianza', function () {
    return Inertia::render('Correccion');
})->name('correcion de varianza');

Route::get('/regresion', function () {
    return Inertia::render('Regresion');
})->name('regresion');
